...
<div class="wrap">
    ...
    if (!Yii::$app->getUser()->isGuest):
        echo Nav::widget([
            ...
            'items' => [
                ['label' => Yii::t('app', 'Twitter Account'), 'url' => ['/tw-account/index'], 'visible' => Yii::$app->user->can('TwitterAccount.Index')],
                ['label' => Yii::t('app', 'Hunt'), 'url' => ['/hunt/index'], 'visible' => Yii::$app->user->can('Hunt.Index')],
                [
...
<footer class="footer">
    <div class="container">
        <p style="text-align:center">&copy; <?= Yii::t('app', 'Test') ?> <?= date('Y') ?></p>
    </div>
</footer>
